    ...
    <>
      <footer className="bg-theme pt-7 pb-5">
        <div className="nike-container text-slate-200">
          <div className="grid items-start grid-cols-3 md:grid-cols-1 max-w-2xl w-full m-auto md:max-w-none md:gap-5">
            {titles.map((val, i) => (
          ...
          <div className="mt-5 text-center">
            <p className="text-sm md:text-center">
              Copyright<sup className="text-xs font-bold">&copy;</sup> All
